    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BackgroundWorker_class backgroundWorker_class = new BackgroundWorker_class(LoginActivity.this);
                backgroundWorker_class.delegate=LoginActivity.this;
                backgroundWorker_class.execute(type,username,password);
